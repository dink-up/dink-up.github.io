...
export function CreateEventView() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const eventData: CreateEventData = {
        ...
        visibility,
        joinType,
        eventCode: visibility === 'code' && eventCode ? eventCode : undefined,
      };
  ...
  const canProceedStep3 = visibility !== 'code' || eventCode;
            ...
            <div className="space-y-4">
              <div>
                ...
                <select
                  ...
                  className="w-full h-11 px-3 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-lg text-slate-900 dark:text-slate-100 focus:outline-none focus:border-teal-600 dark:focus:border-teal-400"
                >
